...
exports.loginService = exports.LoginService = void 0;
var LoginService = /** @class */ (function () {
    function LoginService() {
        var _this = this;
        this.authentication = function (user) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.validation = function (user) {
            var isEmailValid = function () { return /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(user.email); };
            var errors = [];
            if (user.name.trim() === '') {
